...
//shudhu sci-fi movie, ratting onujayi boro theke chuto sajanu

let topSciFi = movies
?.filter((m)=>m.genre=="Sci-Fi")

?.sort((a,b)=>b.rating-a.rating)
?.map((m)=>`${m.title}, rating:${m.rating}`);
...
// শুধু In-Stock Product, Price অনুযায়ী কম থেকে বেশি সাজানো, শুধু Title+Price বের করা,
// টোটাল কত টাকা লাগবে স্টক আউট করতে চাইলে সেটা ক্যালকুলেট করুন।
